...
//Code Here
let lastItemRemoved = arr.pop(0, 5)
  console.log(arr)
...
someNum.push (myFavoriteNumber[6])
...
////////// PROBLEM 10 //////////
// Switch statements can be excellent alternatives to if blocks. Look up switch statements (I recmmend W3 Schools) and try to implement one for the following.
